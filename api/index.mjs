...
config2.runtimeDataModel = JSON.parse('{"models":{"User":{"fields":[{"name":"id","kind":"scalar","type":"String"},{"name":"name","kind":"scalar","type":"String"},{"name":"email","kind":"scalar","type":"String"},{"name":"emailVerified","kind":"scalar","type":"Boolean"},{"name":"image","kind":"scalar","type":"String"},{"name":"createdAt","kind":"scalar","type":"DateTime"},{"name":"updatedAt","kind":"scalar","type":"DateTime"},{"name":"sessions","kind":"object","type":"Session","relationName":"SessionToUser"},{"name":"accounts","kind":"object","type":"Account","relationName":"AccountToUser"},{"name":"role","kind":"enum","type":"Role"},{"name":"phone","kind":"scalar","type":"String"},{"name":"status","kind":"enum","type":"UserStatus"},{"name":"reviews","kind":"object","type":"Review","relationName":"ReviewToUser"}],"dbName":"user"},"Session":{"fields":[{"name":"id","kind":"scalar","type":"String"},{"name":"expiresAt","kind":"scalar","type":"DateTime"},{"name":"token","kind":"scalar","type":"String"},{"name":"createdAt","kind":"scalar","type":"DateTime"},{"name":"updatedAt","kind":"scalar","type":"DateTime"},{"name":"ipAddress","kind":"scalar","type":"String"},{"name":"userAgent","kind":"scalar","type":"String"},{"name":"userId","kind":"scalar","type":"String"},{"name":"user","kind":"object","type":"User","relationName":"SessionToUser"}],"dbName":"session"},"Account":{"fields":[{"name":"id","kind":"scalar","type":"String"},{"name":"accountId","kind":"scalar","type":"String"},{"name":"providerId","kind":"scalar","type":"String"},{"name":"userId","kind":"scalar","type":"String"},{"name":"user","kind":"object","type":"User","relationName":"AccountToUser"},{"name":"accessToken","kind":"scalar","type":"String"},{"name":"refreshToken","kind":"scalar","type":"String"},{"name":"idToken","kind":"scalar","type":"String"},{"name":"accessTokenExpiresAt","kind":"scalar","type":"DateTime"},{"name":"refreshTokenExpiresAt","kind":"scalar","type":"DateTime"},{"name":"scope","kind":"scalar","type":"String"},{"name":"password","kind":"scalar","type":"String"},{"name":"createdAt","kind":"scalar","type":"DateTime"},{"name":"updatedAt","kind":"scalar","type":"DateTime"}],"dbName":"account"},"Verification":{"fields":[{"name":"id","kind":"scalar","type":"String"},{"name":"identifier","kind":"scalar","type":"String"},{"name":"value","kind":"scalar","type":"String"},{"name":"expiresAt","kind":"scalar","type":"DateTime"},{"name":"createdAt","kind":"scalar","type":"DateTime"},{"name":"updatedAt","kind":"scalar","type":"DateTime"}],"dbName":"verification"},"Categories":{"fields":[{"name":"id","kind":"scalar","type":"String"},{"name":"slug","kind":"scalar","type":"String"},{"name":"name","kind":"scalar","type":"String"},{"name":"medicines","kind":"object","type":"Medicine","relationName":"CategoriesToMedicine"},{"name":"createdAt","kind":"scalar","type":"DateTime"},{"name":"updatedAt","kind":"scalar","type":"DateTime"}],"dbName":null},"Medicine":{"fields":[{"name":"id","kind":"scalar","type":"String"},{"name":"images","kind":"scalar","type":"String"},{"name":"name","kind":"scalar","type":"String"},{"name":"price","kind":"scalar","type":"String"},{"name":"discount","kind":"scalar","type":"String"},{"name":"stock","kind":"scalar","type":"Int"},{"name":"categoryId","kind":"scalar","type":"String"},{"name":"category","kind":"object","type":"Categories","relationName":"CategoriesToMedicine"},{"name":"sellerId","kind":"scalar","type":"String"},{"name":"createdAt","kind":"scalar","type":"DateTime"},{"name":"updatedAt","kind":"scalar","type":"DateTime"},{"name":"orders","kind":"object","type":"Order","relationName":"MedicineToOrder"},{"name":"reviews","kind":"object","type":"Review","relationName":"MedicineToReview"}],"dbName":null},"Review":{"fields":[{"name":"id","kind":"scalar","type":"String"},{"name":"title","kind":"scalar","type":"String"},{"name":"descirption","kind":"scalar","type":"String"},{"name":"medicineId","kind":"scalar","type":"String"},{"name":"ratings","kind":"scalar","type":"Int"},{"name":"userId","kind":"scalar","type":"String"},{"name":"medicine","kind":"object","type":"Medicine","relationName":"MedicineToReview"},{"name":"user","kind":"object","type":"User","relationName":"ReviewToUser"},{"name":"createdAt","kind":"scalar","type":"DateTime"},{"name":"updatedAt","kind":"scalar","type":"DateTime"}],"dbName":null},"Order":{"fields":[{"name":"id","kind":"scalar","type":"String"},{"name":"userId","kind":"scalar","type":"String"},{"name":"orderCode","kind":"scalar","type":"String"},{"name":"sellerId","kind":"scalar","type":"String"},{"name":"address","kind":"scalar","type":"String"},{"name":"status","kind":"enum","type":"OrderStatus"},{"name":"order_track","kind":"enum","type":"OrderTrack"},{"name":"quantity","kind":"scalar","type":"Int"},{"name":"medicineId","kind":"scalar","type":"String"},{"name":"medicine","kind":"object","type":"Medicine","relationName":"MedicineToOrder"},{"name":"createdAt","kind":"scalar","type":"DateTime"},{"name":"updatedAt","kind":"scalar","type":"DateTime"}],"dbName":null}},"enums":{},"types":{}}');
...
// src/module/medicine.categories/categories.routes.ts
...
// src/module/medicine.categories/categories.service.ts
...
var getCategoriesBySeller = async () => {
...
var updateCategories = async (categoriesId, data) => {
...
// src/module/medicine.categories/categories.controller.ts
...
var getCategoriesById2 = async (req, res, next) => {
...
var getCategoriesBySeller2 = async (req, res, next) => {
  try {
    const user = req.user;
...
var categoriesController = {
  ...
  getCategoriesBySeller: getCategoriesBySeller2,
...
router.post("/", auth_default("ADMIN" /* ADMIN */), categoriesController.createCategories);
router.patch(
  "/:id",
...
var categoriesRoute = router;

// src/module/order/order.route.ts
import express2 from "express";

// src/helpers/generateRendomOrderCode.ts
var generateOrderCode = () => {
  const random = Math.floor(100 + Math.random() * 900);
  return `ORD-${random}`;
};

// src/module/order/order.service.ts
var getMyOrder = async (authorId, isSeller, page, limit) => {
  const andConditins = [];
  ...
  const whereCondition = isSeller ? { sellerId: authorId } : { userId: authorId };
...
var updateOrder = async (orderId, data, authorId, isSeller) => {
  ...
  if (order.status === OrderStatus.REJECT) {
    if (data.status === OrderStatus.PENDING || data.status === OrderStatus.APPROVED) {
      throw new Error("You can't chenge previous status.");
    }
  }
...
var getMyOrder2 = async (req, res, next) => {
  try {
    const user = req.user;
    if (!user) {
      throw new Error("UnAthorised");
    ...
    const { page, limit } = paginationSortingHelper_default(req.query);
...
var updateOrder2 = async (req, res, next) => {
  try {
    ...
    res.status(201).json({ message: "Status update successfully", data: result });
  } catch (err) {
    next(err);
  }
};
...
router2.post("/", auth_default("CUSTOMER" /* CUSTOMER */), orderController.createOrder);
router2.patch("/:orderId", auth_default("SELLER" /* SELLER */), orderController.updateOrder);
...
var createReview = async (data, userId, medicineId) => {
...
router3.get("/:medicineId", reviewController.getAllReview);
router3.post("/:medicineId", auth_default("CUSTOMER" /* CUSTOMER */), reviewController.createReview);
var reviewRoute = router3;
...
var userProfile = async (authorId) => {
...
var updateUserStatus = async (payload, userId) => {
...
var userProfile2 = async (req, res, next) => {
  try {
    const user = req.user;
    if (!user) {
      throw new Error("UnAthorised");
...
router4.get("/admin", auth_default("ADMIN" /* ADMIN */), profileController.getUser);
router4.patch(
  "/admin/:userId",
  auth_default("ADMIN" /* ADMIN */),
  profileController.updateUserStatus
);
var profileRoute = router4;
...
var getAllMedicine = async ({
  ...
  const allMedicineData = allMedicine.map((medicine) => {
    ...
    const avg_ratings = total_review === 0 ? 0 : medicine.reviews.reduce((sum, r) => sum + r.ratings, 0) / total_review;
    return {
      id: medicine.id,
...
var updateMedicineById = async (medicineId, data, authorId) => {
...
var deleteMedicine = async (sellerId, authorId, isAdmin) => {
  const medicineData = await prisma.medicine.findUniqueOrThrow({
    where: {
      id: sellerId
    },
...
// src/helpers/imgbbUploadHelper.ts
var import_form_data = __toESM(require_form_data(), 1);
import axios from "axios";
var uploadToImgbb = async (fileBuffer) => {
...
router5.get("/", medicineController.getAllMedicine);
router5.get("/:medicineId", medicineController.getMedicineById);
router5.patch(
  "/:medicineId",
  auth_default("SELLER" /* SELLER */),
  medicineController.updateMedicineById
);
router5.post("/", auth_default("SELLER" /* SELLER */), medicineController.createMedicine);
router5.delete(
  "/:medicineId",
  auth_default("SELLER" /* SELLER */, "ADMIN" /* ADMIN */),
  medicineController.deleteMedicine
);
var medicineRoute = router5;
